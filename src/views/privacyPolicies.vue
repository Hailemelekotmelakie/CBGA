<template>
  <div class="privacyPolicy">
    ...
    <p>
      At Job vacancy, accessible from
      <a href="https://www.cbgacom">www.vacancy.huliesira.com</a>, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by Job vacancy and how we use
      it.
    </p>
    ...
    <p>
      ...
      Job vacancy. This policy is not applicable to any information collected offline or
    ...
    <p>
      Job vacancy follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Job vacancy uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      on Job vacancy, which are sent directly to users' browser. They automatically
    ...
    <p>
      Note that Job vacancy has no access to or control over these cookies that are used
    ...
    <p>
      Job vacancy's Privacy Policy does not apply to other advertisers or websites. Thus,
    ...
    <p>
      Job vacancy does not knowingly collect any Personal Identifiable Information from
